...
import com.shinedev.digitalent.data.local.provider.DatabaseContract
import com.shinedev.digitalent.data.local.provider.DatabaseContract.getColumnString
...
class WidgetRemoteViewsFactory(private val mContext: Context) :
    ...
    override fun getViewAt(position: Int): RemoteViews {
        ...
        rv.setTextViewText(
            ...
            DateFormatter.formatDate(mWidgetItems[position].createdAt, TimeZone.getDefault().id)
        )
