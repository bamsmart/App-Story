package com.shinedev.digitalent.ui.splash
...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupView()
        val pref = AuthPreferenceDataStore.getInstance(dataStore)
    ...
    private suspend fun initDirection(pref: AuthPreferenceDataStore) {
