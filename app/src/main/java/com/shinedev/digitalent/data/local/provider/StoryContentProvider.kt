...
import com.shinedev.digitalent.data.local.provider.DatabaseContract.CONTENT_AUTHORITY_STORY
import com.shinedev.digitalent.data.local.provider.DatabaseContract.TABLE_STORY
