package com.shinedev.digitalent.data.provider
...
import com.shinedev.digitalent.data.provider.DatabaseContract.CONTENT_AUTHORITY_STORY
import com.shinedev.digitalent.data.provider.DatabaseContract.TABLE_STORY

class StoryContentProvider : ContentProvider() {

    companion object {
        private const val STORY = 1
        private const val STORY_ID = 2
    }
